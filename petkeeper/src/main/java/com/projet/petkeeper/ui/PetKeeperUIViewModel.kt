...
open class PetKeeperUIViewModel : ViewModel() {
    ...
    /**
     * Searches for chats based on a query string.
     *
     * @param queryString The query string used for chat search.
     */
    ...
    /**
     * Updates the selected job in the UI state with the provided [jobData].
     *
     * @param jobData The job data to set as the selected job.
     */
